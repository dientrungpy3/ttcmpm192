...
import sfcs.bkfoodcourt.src.module.cate.view.CateFragment;
import sfcs.bkfoodcourt.src.module.explore.view.ExploreFragment;
import sfcs.bkfoodcourt.src.module.favourite.view.FavouriteFragment;
import sfcs.bkfoodcourt.src.module.myorder.view.MyOrderActivity;
import sfcs.bkfoodcourt.src.module.profile.view.ProfileFragment;
import sfcs.bkfoodcourt.src.utils.ViewPagerNavigationAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                Log.d("sfcs", "onPageSelected: " + position);
