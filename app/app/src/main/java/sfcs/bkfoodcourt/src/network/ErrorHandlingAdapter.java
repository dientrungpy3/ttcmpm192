        ...
        @Override public void enqueue(final MyCallback<T> callback) {
            call.enqueue(new Callback<T>() {
                @Override public void onResponse(Call<T> call, Response<T> response) {
                    ...
                    Log.d("sfcs", "onResponse: day ne " + response.body().toString());
                    ...
                    if(response.isSuccessful()){
                        ...
                        if (code == 401) {
                            ...
                            Log.d("sfcs", "onResponse: ======");
                            Log.d("sfcs", "onResponse: err" + response.body().toString());
                            Log.d("sfcs", "onResponse: err okhtp" + response.errorBody());
//                        callback.clientError((Response<ErrorResponse>) response);
                            callback.clientError(response);
//                        Log.d("sfcs", "onResponse: client " + response.body());
