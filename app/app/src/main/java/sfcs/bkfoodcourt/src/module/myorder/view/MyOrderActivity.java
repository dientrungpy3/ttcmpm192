package sfcs.bkfoodcourt.src.module.myorder.view;
...
import sfcs.bkfoodcourt.src.module.myorder.AdapterCartProvisional;
import sfcs.bkfoodcourt.src.module.myorder.IOnClickCart;
import sfcs.bkfoodcourt.src.module.myorder.IOrder;
import sfcs.bkfoodcourt.src.module.myorder.presenter.PresenterOrder;
import sfcs.bkfoodcourt.src.module.register.view.RegisterActivity;
import sfcs.bkfoodcourt.src.utils.DialogLoading;
import sfcs.bkfoodcourt.src.utils.SplashScreenActivity;
...
public class MyOrderActivity extends AppCompatActivity implements IOnClickCart, IOrder.IViewOrder {
    ...
    public void onCheckGiftSuccess(Gift gift) {
        ...
        try {
            ...
            Log.d("sfcs", "onCheckGiftSuccess: Exception " + e.getMessage());
        }
